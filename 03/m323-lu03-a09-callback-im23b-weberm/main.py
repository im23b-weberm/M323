...
class GreetingApp:
    ...
    def __init__(self, root2):
        ...
        """
        # Hauptfenster in self.root speichern und Titel setzen
        self.root = root2
        ...
        # Label-Widget für die Begrüßungsnachricht (anfangs leer)
        ...
        self.button = tk.Button(self.root, text="Begrüßen", command=self.greet_user)
